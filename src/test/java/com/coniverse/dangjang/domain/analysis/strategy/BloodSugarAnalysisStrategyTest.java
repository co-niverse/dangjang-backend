...
class BloodSugarAnalysisStrategyTest {
	...
	private Stream<Arguments> provideBloodSugarAnalysisData() {
		return Stream.of(
			...
			Arguments.of(전단계_환자, 공복_혈당_타입, "50", "69", Alert.CAUTION),
			...
			Arguments.of(전단계_환자, 식후_혈당_타입, "50", "89", Alert.CAUTION),
			...
			Arguments.of(당뇨_환자, 공복_혈당_타입, "50", "79", Alert.CAUTION),
			...
			Arguments.of(당뇨_환자, 식후_혈당_타입, "50", "89", Alert.CAUTION),
